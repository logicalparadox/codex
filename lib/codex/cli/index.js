var Drip = require('drip')
  ...
  , path = require('path')
  , join = path.join
  , exists = path.existsSync || require('fs').existsSync;
...
var help = [
  ...
  , options: [
        { '-i, --in [inDir]': 'Specify the root directory for your project. Replaced [cwd] as base for defaults.' }
  ...
  , options: [
      ...
      , { '-m, --mount [base]': 'Specify the folder path to mounth the static server at.' }
    ]
  },
